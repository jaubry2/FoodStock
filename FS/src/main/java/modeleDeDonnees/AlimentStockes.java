...
public class AlimentStockes {
    ...
    /**
     * Constructeur par défaut de la classe AlimentStockes nécessaire pour la base de données.
     */
    ...
    /**
     * L'identifiant unique de l'aliment stocké en base de données.
     */
    private Long id;
    ...
    @ManyToOne
    @JoinColumn(name = "idAlimemts", referencedColumnName = "id", nullable = false)
    /**
     * L'aliment stocké.
     */
     ...
     *
     * @return la date de péremption de l'aliment stocké
     */
     ...
     *
     * @param datePeremption la nouvelle date de péremption de l'aliment stocké
     */
