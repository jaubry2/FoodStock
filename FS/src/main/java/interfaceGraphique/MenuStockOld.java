 ...
 * @author julesa
 */
public class MenuStockOld extends javax.swing.JFrame {
    /**
    ...
    */
    private void stockButtonActionPerformed(java.awt.event.ActionEvent evt) {
        MenuStockOld newPage = new MenuStockOld();
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuStockOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {        
                new MenuStockOld().setVisible(true);
            }
        });
    }
}
